...
export class ViewAttributesApi {
  ...
  public static setAttrValues(vp: Viewport, attrValues: AttrValues) {
    ...
    vp.viewFlags = vp.viewFlags.copy({
      acsTriad: attrValues.acs,
      backgroundMap: attrValues.backgroundMap,
      grid: attrValues.grid,
      hiddenEdges: attrValues.hiddenEdges,
      monochrome: attrValues.monochrome,
      shadows: attrValues.shadows,
      visibleEdges: attrValues.visibleEdges,
     // adviced by Paul Connelly - 11/11/2022
   });
  ...
  public static setViewFlag(vp: Viewport, flag: ViewFlag, on: boolean) {
    switch (flag) {
      case ViewFlag.ACS:
        ...
        vp.viewFlags = vp.viewFlags.copy({ acsTriad: true });
        break;
      ...
      case ViewFlag.Grid:
        ...
        vp.viewFlags = vp.viewFlags.with("grid", true);
        break;
      case ViewFlag.HiddenEdges:
        // vp.viewFlags.hiddenEdges = on;
        vp.viewFlags = vp.viewFlags.with("hiddenEdges", true);
        break;
      case ViewFlag.Monochrome:
        // vp.viewFlags.monochrome = on;
        vp.viewFlags = vp.viewFlags.with("monochrome", true);
        break;
      ...
      case ViewFlag.VisibleEdges:
        ...
        vp.viewFlags = vp.viewFlags.copy({ visibleEdges: true });
        break;
    }
    vp.synchWithView();
  }
